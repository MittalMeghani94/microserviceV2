...
import com.demo.microservice.CurrencyExchangeProxy;
import com.demo.microservice.bean.CurrencyConversion;
...
public class CurrencyCoversionController {
	...
	@GetMapping("currency-conversion-feign/msg/{msg}")
	public String calculateCurrencyConversionFeignNew(
			@PathVariable String msg) {
		
		return msg +" - feign new";
	}
}
